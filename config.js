...
module.exports = kconfig = async (kill, message) => {
    try {
        ...
        const ownerNumber = '5553997120889@c.us'
	...
	const isOwner = isOwn.includes(ownerNumber)
		...
		case 'about':
			await kill.sendFile(from, './lib/media/img/suno.png', 'suno.png', sobre, id)
			break
        ...
        case 'stickernobg':
			if (isMedia) {
                try {
                    ...
                    var result = await removeBackgroundFromImageBase64({ base64img, apiKey: 'W46eoYe61nb5NEtgiLtc7RKV', size: 'auto', type: 'auto', outFile }) // bota sua propria api ai, cuidado no limite mensal
		...
		case 'simg':
            if (isMedia && type === 'image') {
				...
				const upimg = await imgbbUploader("73d71480402c36e78dcfa8b69a8d8288", seaimg) // Bote uma api do imgbb pras suas fotos n irem pra minha conta
		...
		case 'upimg':
            if (isMedia && type === 'image') {
				...
				const sdimg = await imgbbUploader("73d71480402c36e78dcfa8b69a8d8288", uplimg) // Bote uma api do imgbb pras suas fotos n irem pra minha conta
		...
		case 'legiao':
			...
			kill.sendLinkWithAutoPreview(from, 'https://chat.whatsapp.com/IlwIus5EuRi4BScxeNmhJE', id)
			break
      ...
      case 'moddroid':
        ...
        case 'join':
            ...
            if (tGr.length > 8) return kill.reply(from, 'Já estou no maximo de grupos, desculpe.', id)
